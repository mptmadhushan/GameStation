...
<head>
	...
	<title> REMOVE GAME | GameStation </title>
...
<body>
    ...
    <div class="mainArea" align="center">
        ...
        <div class="content">
			...
			<font size = "10" ><b> REMOVE GAME </b></font>
			<br>
			...
			<form method = "POST" action = "remove-game">

				  <input type = "text" name = "gameName" placeholder = "ADD Game Name" required/><br>
				 
				  <input type = "text" name="GameID" placeholder="Enter the Game ID*" required><br/>
